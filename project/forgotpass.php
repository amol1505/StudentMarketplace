...
if(isset($_POST['submit'])) {
    ...
    if($decryptedpass == $password) {
        $idquery=mysqli_query($con,"select id from user where email='$email'");
        $userid = $idquery->fetch_array()[0] ?? '';
        $hashedpass=encrypt($newpassword, $keyhash);
        mysqli_query($con,"update user SET password='$hashedpass' WHERE id='$userid'");
                    ...
                    <div class="border border">
                        ...
                        <form method="post">
                            <fieldset class="p-4">
                                ...
                                <input type="password" name="password" placeholder="Old Password*" class="border p-3 w-100 my-2" required>
                                <input type="password" name="newpassword" placeholder="New Password*" class="border p-3 w-100 my-2" required>
                                <div class="loggedin-forgot d-inline-flex my-3">
                                        <input type="checkbox" id="registering" class="mt-1">
                                        <label for="registering" class="px-2">I'm sure I want to change my password</a></label>
                                </div>
